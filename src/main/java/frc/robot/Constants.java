...
public final class Constants {
	...
	public static final class Drive {
		public static final class Known {
			...
			public static final ModuleConfiguration SDS_MODULE_CONFIGURATION
		...
		public static final class Calculated {
			public static final SwerveDriveKinematics KINEMATICS
							= new SwerveDriveKinematics(new Translation2d(	Drive.Known.TRACKWIDTH_METERS	/ 2.0,
			...
			static public final double MAX_FWD_REV_SPEED_MPS_EST
							= Known.MAX_DRIVE_MOTOR_RPM / 60.0 * Known.SDS_MODULE_CONFIGURATION.getDriveReduction() * Known.SDS_MODULE_CONFIGURATION.getWheelDiameter() * Math.PI;
			static public final double MAX_ROTATE_SPEED_RAD_PER_SEC_EST
							= MAX_FWD_REV_SPEED_MPS_EST / Math.hypot(Known.TRACKWIDTH_METERS / 2.0, Known.WHEELBASE_METERS / 2.0);
			static public final double MAX_ROTATE_SPEED_RAD_PER_SEC_MOTOR_EST
							= Known.MAX_DRIVE_MOTOR_RPM / 60 * Known.SDS_MODULE_CONFIGURATION.getSteerReduction() * 2 * Math.PI;
		}

		public static final class Config {
			public static final SwerveDrivetrainModel.Configuration MODEL_CONFIGURATION
							= new SwerveDrivetrainModel.Configuration(	Calculated.MAX_FWD_REV_SPEED_MPS_EST,
																		...
																		1, 0.25,
																		0.25);
			public static final SwerveModule.Tunings SWERVE_MODULE_TUNINGS
							= new SwerveModule.Tunings(	Calculated.MAX_FWD_REV_SPEED_MPS_EST,
	...
	public static final class Climber {
		...
		public static final double ARM_DEGREES_TO_FALCON_TICKS
						= CLIMB_ARM_GEAR_RATIO * Encoder.ENC_PULSE_PER_REV / 360.0;
		public static final double FALCON_TICKS_TO_ARM_DEGREES
						= 1 / ARM_DEGREES_TO_FALCON_TICKS;
		public static final double MAX_ARM_VELOCITY_DEGREES_PER_SECOND = 51.0;
		public static final double MAX_ARM_ACCELERATION_DEGREES_PER_SECOND_PER_SECOND
						= 80.0;
		public static final double MAX_ARM_VELOCITY_DEGREES_PER_SECOND_SLOW
						= 45.0;
		public static final double MAX_ARM_ACCELERATION_DEGREES_PER_SECOND_PER_SECOND_SLOW
						= 50.0;
		public static final int MAX_ARM_VELOCITY_NATIVE_UNITS
						= (int) (MAX_ARM_VELOCITY_DEGREES_PER_SECOND * ARM_DEGREES_TO_FALCON_TICKS / 10.0);
		public static final int MAX_ARM_ACCELERATION_NATIVE_UNITS
						= (int) (MAX_ARM_ACCELERATION_DEGREES_PER_SECOND_PER_SECOND * ARM_DEGREES_TO_FALCON_TICKS / 10.0);
		public static final int MAX_ARM_VELOCITY_NATIVE_UNITS_SLOW
						= (int) (MAX_ARM_VELOCITY_DEGREES_PER_SECOND_SLOW * ARM_DEGREES_TO_FALCON_TICKS / 10.0);
		public static final int MAX_ARM_ACCELERATION_NATIVE_UNITS_SLOW
						= (int) (MAX_ARM_ACCELERATION_DEGREES_PER_SECOND_PER_SECOND_SLOW * ARM_DEGREES_TO_FALCON_TICKS / 10.0);
		...
		public static final double HIGHTRAVERSALBAR_RECENTER_ANGLE_COMMAND
						= 400.0; // would be sitting perpendicular to the bars at 360
	...
	public static final class Encoder {
		...
		static public final int WHEEL_ENC_COUNTS_PER_WHEEL_REV
						= ENC_PULSE_PER_REV; // Assume 1-1 gearing for now
		static public final double WHEEL_ENC_WHEEL_REVS_PER_COUNT
						= 1.0 / ((double) (WHEEL_ENC_COUNTS_PER_WHEEL_REV));
		static public final int STEER_ENC_COUNTS_PER_MODULE_REV = 4096; // CANCoder
		static public final double steer_ENC_MODULE_REVS_PER_COUNT
						= 1.0 / ((double) (STEER_ENC_COUNTS_PER_MODULE_REV));
	}
	...
	public static final class Shooter {
		...
		public static final double RPM_TO_COUNTS_PER_100MS
						= Encoder.ENC_PULSE_PER_REV / 600.0 / SHOOT_MOTOR_GEAR_RATIO;
	}
}
