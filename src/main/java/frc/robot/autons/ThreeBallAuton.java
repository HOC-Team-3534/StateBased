...
import static frc.robot.autons.ThreeBallAutonPhase.BOOT1;
import static frc.robot.autons.ThreeBallAutonPhase.NEUTRAL;
import static frc.robot.autons.ThreeBallAutonPhase.PICKUPBALL1;
import static frc.robot.autons.ThreeBallAutonPhase.PUNCH1;
import static frc.robot.autons.ThreeBallAutonPhase.PUNCH2;
import static frc.robot.autons.ThreeBallAutonPhase.RESETPUNCH1;
import static frc.robot.autons.ThreeBallAutonPhase.RESETPUNCH2;
import static frc.robot.autons.ThreeBallAutonPhase.SHOOTBALL1;
import static frc.robot.autons.ThreeBallAutonPhase.SHOOTBALL2;
...
public class ThreeBallAuton extends BaseAutonSequence<ThreeBallAutonPhase> {
	...
	public void process() {
		...
		switch (getPhase()) {
			...
			case SHOOTBALL1:
				// THE FOLLOWING IS ONLY IN ORDER TO SET THE CORRECT INITIAL
				// POSITION
				ballsShot = 0;
